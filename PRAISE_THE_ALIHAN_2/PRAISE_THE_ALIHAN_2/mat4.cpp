...
namespace prototype {
	namespace maths {
		...
		mat4 mat4::orhtographic(float left, float right, float bottom, float top, float near, float far) {
			mat4 result(1.0f);
		...
		mat4 mat4::perspective(float fov, float aspectRatio, float near, float far) {
			...
			float q = 1.0f / tan(toRadians(.05f * fov));
